...
switch ($type) {
    ...
    case 'LoadFriendsCheckboxes':
        ...
        foreach ($friendsList as $name) {
            $friendsCheckboxes .= '<input type="checkbox" id="' .$name. '" class="css-checkbox" name="usersToBattle[]" value="' .$name. '" /><label for="' .$name. '" class="css-label">' .$name. '</label><br/>';
        }


        echo $friendsCheckboxes;
